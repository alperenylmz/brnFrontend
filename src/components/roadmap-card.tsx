...
const RoadmapCard = (props: Roadmap) => {
  return (
    <div className="w-[400px] rounded-lg bg-opacity-10 bg-black shadow-lg transform transition-all duration-300 hover:scale-105 hover:bg-opacity-30 p-6 flex flex-col justify-between">
